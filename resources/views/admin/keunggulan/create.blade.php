            ...
            <div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 items-start">
                    ...
                    <div>
                        ...
                        <div class="flex gap-3 items-center">
                            ...
                            <input type="text" id="icon-input" name="ikon" value="{{ old('ikon') }}" class="flex-1 bg-gray-50 border border-gray-200 rounded-xl px-4 py-3 text-sm focus:outline-none focus:border-emerald-500" placeholder="Masukkan kode fa-ikon">
                        </div>
                    </div>
                </div>
                ...
                <script>
                    document.addEventListener('DOMContentLoaded', function() {
                        ...
                        // Run initial preview if old value exists
                        if (input.value) {
