...
<div class="bg-white shadow rounded-lg p-6 max-w-4xl mx-auto">
    <div class="mb-6 border-b pb-4 flex items-center justify-between">
        <h2 class="text-xl font-bold text-gray-800">Tambah Destinasi</h2>
    ...
    <form action="{{ route('admin.destinasi.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
        @csrf
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <input type="text" name="nama_destinasi_id" value="{{ old('nama_destinasi_id') }}"
                ...
                <div>
                    ...
                    <textarea name="deskripsi_id" rows="4"
                        class="w-full border-gray-300 rounded-md shadow-sm border p-2 focus:ring-blue-500 focus:border-blue-500" required>{{ old('deskripsi_id') }}</textarea>
                </div>
            </div>
            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <input type="text" name="nama_destinasi_en" value="{{ old('nama_destinasi_en') }}"
                    ...
                    <select name="kategori_en" class="w-full border-gray-300 rounded-md shadow-sm border p-2 focus:ring-blue-500 focus:border-blue-500">
                        ...
                        @foreach($kategori as $kat)
                            <option value="{{ $kat->kategori_en }}"
                                {{ old('kategori_en') == $kat->kategori_en ? 'selected' : '' }}>
                                {{ $kat->kategori_en }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div>
                    ...
                    <textarea name="deskripsi_en" rows="4"
                        class="w-full border-gray-300 rounded-md shadow-sm border p-2 focus:ring-blue-500 focus:border-blue-500">{{ old('deskripsi_en') }}</textarea>
                </div>
            </div>
        </div>
